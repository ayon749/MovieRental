...
namespace UniversityProject.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudnetId,Name,RegNo,Address,Age,DepartmentId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudnetId,Name,RegNo,Address,Age,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
